...
<body>
    ...
    <div class="container">
        <form class="form" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['firstNum'] && $_POST['secondNum'] && $_POST['operation']) {
                $result = '';
                switch ($_POST['operation']) {
                    ...
                    default:
                        $result = "You should enter a valid numbers";
                        break;
                }
                echo $_POST['firstNum'] . $_POST['operation'] . $_POST['secondNum'] ." = " . $result;
            }
            ?>
        </form>
    </div>
