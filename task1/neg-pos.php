...
<body>
    ...
    <div class="container">
        <form class="form" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
            <h1 class="text-center">Check either Number is Negative or positive</h1>
            <div class="mb-3">
                <label for="num" class="form-label">Enter Number</label>
                <input type="number" class="form-control form-outline" id="num" name="num">
            </div>
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['num']) {
                switch ($_POST['num']) {
                    case $_POST['num'] < 0:
                        echo $_POST['num'] . " is Negative";
                        break;

                    case $_POST['num'] > 0:
                        echo $_POST['num'] . " is Positive";
                        break;

                    default:
                        echo $_POST['num'] . " is neither Positive nor negative";
                        break;
                }
            }
            ?>
