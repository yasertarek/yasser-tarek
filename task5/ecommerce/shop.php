...
$productRows = $productModel->all(['*'], [["status", "=", "1"]])->fetch_all(MYSQLI_ASSOC);
// Check Category and Subcategory and Brands
if ($_GET) {
    // Check for ctegories
    if (isset($_GET['category'])) {
        echo 'category';
        $productRows = $productModel->all(['*'], [["status", "=", "1"], ["category_id", "=", $_GET['category']]])->fetch_all(MYSQLI_ASSOC);
    } else if (isset($_GET['subcategory'])) {
        echo 'subcategory';
        $productRows = $productModel->all(['*'], [["status", "=", "1"], ["subcategory_id", "=", $_GET['subcategory']]])->fetch_all(MYSQLI_ASSOC);
    } else if (isset($_GET['brand'])) {
        echo 'brand';
        $productRows = $productModel->all(['*'], [["status", "=", "1"], ["brand_id", "=", $_GET['brand']]])->fetch_all(MYSQLI_ASSOC);
    } else {
        header("Location: {$dir__lay}errors/404.php");die;
    }
}
// print_r($productRows);
?>
            ...
            <div class="col-lg-9">
                ...
                <div class="grid-list-product-wrapper">
                    <div class="product-grid product-view pb-20">
                        <div class="row">
                            <?php
                            foreach ($productRows as $productKey => $productVal) {
                            ?>
                                <div class="product-width col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 mb-30">
                                    <div class="product-wrapper">
                                        <div class="product-img">
                                            <a href="product-details.php?id=<?= $productVal['id'] ?>">
                                                <img alt="" src="<?= $dir__productImg . $productVal['image'] ?>">
                                            </a>
                                        ...
                                        <div class="product-content text-left">
                                            <div class="product-hover-style">
                                                <div class="product-title">
                                                    <h4>
                                                        <a href="product-details.html"><?= $productVal['name_en'] ?></a>
                                                    </h4>
                                                </div>
                                            ...
                                            <div class="product-price-wrapper">
                                                <span><?= $productVal['price'] ?> EGP</span>
                                            </div>
                                        </div>
...
<!-- Shop Page Area End -->
<!-- Footer style Start -->
<?php include_once $dir__lay . "footer.php"; ?>
<!-- Footer style End -->
<!-- Modal -->
