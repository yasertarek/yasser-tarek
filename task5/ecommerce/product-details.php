...
if ($_GET) {
    if (isset($_GET['id'])) {
        if (is_numeric($_GET['id'])) {
            $productResult = $productModel->all(["*"], [["id", "=", $_GET['id']]]);
        ...
        <div class="row">
            <div class="col-lg-6 col-md-12">
                <div class="product-details-img">
                    <img class="zoompro" src="<?= $dir__productImg . $productRow->image ?>" data-zoom-image="assets/img/product-details/product-detalis-bl1.jpg" alt="zoom" />
                </div>
            </div>
            <div class="col-lg-6 col-md-12">
                <div class="product-details-content">
                    <h4><?= $productRow->name_en ?></h4>
                    <div class="rating-review">
                        ...
                        <!-- Get Product reviews Count From Databas -->
